...
# Set DB_ENGINE=mysql and the DB_* values in .env for production. SQLite lets the demo run immediately.
if os.getenv('DB_ENGINE', 'sqlite') == 'mysql':
    DATABASES = {'default': {'ENGINE':'django.db.backends.mysql','NAME':os.getenv('DB_NAME','assetflow'),'USER':os.getenv('DB_USER','root'),'PASSWORD':os.getenv('DB_PASSWORD',''),'HOST':os.getenv('DB_HOST','127.0.0.1'),'PORT':os.getenv('DB_PORT','3306'),'OPTIONS':{'charset':'utf8mb4'}}}
else:
...
DEFAULT_FROM_EMAIL=os.getenv('DEFAULT_FROM_EMAIL','no-reply@assetflow.local')
